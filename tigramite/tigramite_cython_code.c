...
static char __pyx_k_tigramite_tigramite_cython_code[] = "tigramite.tigramite_cython_code";
...
static PyObject *__pyx_n_s_tigramite_tigramite_cython_code;
...
/* "tigramite/tigramite_cython_code.pyx":10
 * @cython.boundscheck(False)
...
static PyMethodDef __pyx_mdef_9tigramite_21tigramite_cython_code_1_get_neighbors_within_eps_cython = {"_get_neighbors_within_eps_cython", (PyCFunction)__pyx_pw_9tigramite_21tigramite_cython_code_1_get_neighbors_within_eps_cython, METH_VARARGS|METH_KEYWORDS, 0};
 ...
 */
  ...
  /* "tigramite/tigramite_cython_code.pyx":20
 * 
 *     cdef int[:] k_xz = numpy.zeros(T, dtype='int32')
 *     cdef int[:] k_yz = numpy.zeros(T, dtype='int32')             # <<<<<<<<<<<<<<
 *     cdef int[:] k_z = numpy.zeros(T, dtype='int32')
 ...
 */
  ...
  /* "tigramite/tigramite_cython_code.pyx":21
 *     cdef int[:] k_xz = numpy.zeros(T, dtype='int32')
 *     cdef int[:] k_yz = numpy.zeros(T, dtype='int32')
 *     cdef int[:] k_z = numpy.zeros(T, dtype='int32')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "tigramite/tigramite_cython_code.pyx":27
 * 
 ...
 */
    ...
    /* "tigramite/tigramite_cython_code.pyx":34
 *         # Count neighbors within epsmax in subspaces, since the reference
 ...
 */
    ...
    /* "tigramite/tigramite_cython_code.pyx":35
 *         # point is included, all neighbors are at least 1
 *         kz = 0
 *         kxz = 0             # <<<<<<<<<<<<<<
 *         kyz = 0
 ...
 */
    ...
    /* "tigramite/tigramite_cython_code.pyx":37
 *         kxz = 0
 *         kyz = 0
 *         for j in range(T):             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
      ...
      /* "tigramite/tigramite_cython_code.pyx":40
 * 
 *             # Z-subspace, if empty, dz stays 0
 *             dz = 0.             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "tigramite/tigramite_cython_code.pyx":41
 *             # Z-subspace, if empty, dz stays 0
 *             dz = 0.
 *             for d in range(dim_x+dim_y, dim):             # <<<<<<<<<<<<<<
 *                 dz = max( abs(array[d, i] - array[d, j]), dz)
 ...
 */
      ...
      for (__pyx_t_12 = (__pyx_v_dim_x + __pyx_v_dim_y); __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
        ...
        /* "tigramite/tigramite_cython_code.pyx":42
 *             dz = 0.
 *             for d in range(dim_x+dim_y, dim):
 *                 dz = max( abs(array[d, i] - array[d, j]), dz)             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        __pyx_v_dz = __pyx_f_9tigramite_21tigramite_cython_code_max(fabs(((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_array.data + __pyx_t_13 * __pyx_v_array.strides[0]) ) + __pyx_t_14 * __pyx_v_array.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_array.data + __pyx_t_15 * __pyx_v_array.strides[0]) ) + __pyx_t_16 * __pyx_v_array.strides[1]) ))))), __pyx_v_dz);
      }
 ...
 */
        ...
        /* "tigramite/tigramite_cython_code.pyx":52
 *                 # Y-subspace, the loop is only entered for dim_y > 1
 *                 dy = abs(array[dim_x, i] - array[dim_x, j])
 *                 for d in range(dim_x+1, dim_x+dim_y):             # <<<<<<<<<<<<<<
 *                     dy = max( abs(array[d, i] - array[d, j]), dy)
 ...
 */
        ...
        for (__pyx_t_12 = (__pyx_v_dim_x + 1); __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
          ...
          /* "tigramite/tigramite_cython_code.pyx":53
 *                 dy = abs(array[dim_x, i] - array[dim_x, j])
 *                 for d in range(dim_x+1, dim_x+dim_y):
 *                     dy = max( abs(array[d, i] - array[d, j]), dy)             # <<<<<<<<<<<<<<
 * 
 ...
 */
          ...
          __pyx_v_dy = __pyx_f_9tigramite_21tigramite_cython_code_max(fabs(((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_array.data + __pyx_t_22 * __pyx_v_array.strides[0]) ) + __pyx_t_23 * __pyx_v_array.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_array.data + __pyx_t_24 * __pyx_v_array.strides[0]) ) + __pyx_t_25 * __pyx_v_array.strides[1]) ))))), __pyx_v_dy);
        }
 ...
 */
        ...
        if (__pyx_t_17) {
          ...
          /* "tigramite/tigramite_cython_code.pyx":56
 * 
 *                 if (dy < epsmax):
 *                     kyz += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        /* "tigramite/tigramite_cython_code.pyx":59
 * 
 *                 # X-subspace, the loop is only entered for dim_x > 1
 ...
 */
          ...
          __pyx_v_dx = __pyx_f_9tigramite_21tigramite_cython_code_max(fabs(((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_array.data + __pyx_t_30 * __pyx_v_array.strides[0]) ) + __pyx_t_31 * __pyx_v_array.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_array.data + __pyx_t_32 * __pyx_v_array.strides[0]) ) + __pyx_t_33 * __pyx_v_array.strides[1]) ))))), __pyx_v_dx);
        }

        /* "tigramite/tigramite_cython_code.pyx":63
 *                     dx = max( abs(array[d, i] - array[d, j]), dx)
 * 
 *                 if (dx < epsmax):             # <<<<<<<<<<<<<<
 *                     kxz += 1
 ...
 */
    ...
    /* "tigramite/tigramite_cython_code.pyx":67
 * 
 *         # Write to arrays
 *         k_xz[i] = kxz             # <<<<<<<<<<<<<<
 *         k_yz[i] = kyz
...
static PyMethodDef __pyx_mdef_9tigramite_21tigramite_cython_code_3_get_patterns_cython = {"_get_patterns_cython", (PyCFunction)__pyx_pw_9tigramite_21tigramite_cython_code_3_get_patterns_cython, METH_VARARGS|METH_KEYWORDS, 0};
...
static PyObject *__pyx_pf_9tigramite_21tigramite_cython_code_2_get_patterns_cython(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_array, __Pyx_memviewslice __pyx_v_array_mask, __Pyx_memviewslice __pyx_v_patt, __Pyx_memviewslice __pyx_v_patt_mask, __Pyx_memviewslice __pyx_v_weights, int __pyx_v_dim, int __pyx_v_step, __Pyx_memviewslice __pyx_v_fac, int __pyx_v_N, int __pyx_v_T) {
  ...
  /* "tigramite/tigramite_cython_code.pyx":91
 ...
 */
  ...
  /* "tigramite/tigramite_cython_code.pyx":93
 *     cdef double[:] v = numpy.zeros(dim, dtype='float')
 * 
 *     start = step*(dim-1)             # <<<<<<<<<<<<<<
 *     for n in range(0, N):
 ...
 */
  ...
  /* "tigramite/tigramite_cython_code.pyx":94
 * 
 *     start = step*(dim-1)
 *     for n in range(0, N):             # <<<<<<<<<<<<<<
 *         for t in range(start, T):
 ...
 */
  ...
  for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
    ...
    /* "tigramite/tigramite_cython_code.pyx":95
 *     start = step*(dim-1)
 *     for n in range(0, N):
 *         for t in range(start, T):             # <<<<<<<<<<<<<<
 *             mask = 1
 ...
 */
    ...
    for (__pyx_t_9 = __pyx_v_start; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
      ...
      /* "tigramite/tigramite_cython_code.pyx":96
 *     for n in range(0, N):
 *         for t in range(start, T):
 *             mask = 1             # <<<<<<<<<<<<<<
 *             ave = 0.
 ...
 */
      ...
      /* "tigramite/tigramite_cython_code.pyx":97
 *         for t in range(start, T):
 *             mask = 1
 *             ave = 0.             # <<<<<<<<<<<<<<
 *             for k in range(0, dim):
 ...
 */
      ...
      /* "tigramite/tigramite_cython_code.pyx":98
 *             mask = 1
 *             ave = 0.
 *             for k in range(0, dim):             # <<<<<<<<<<<<<<
 *                 tau = k*step
 ...
 */
      ...
      for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
        ...
        /* "tigramite/tigramite_cython_code.pyx":99
 *             ave = 0.
 *             for k in range(0, dim):
 *                 tau = k*step             # <<<<<<<<<<<<<<
 *                 v[k] = array[t - tau, n]
 ...
 */
        ...
        *((double *) ( /* dim=0 */ (__pyx_v_v.data + __pyx_t_14 * __pyx_v_v.strides[0]) )) = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_array.data + __pyx_t_12 * __pyx_v_array.strides[0]) ) + __pyx_t_13 * __pyx_v_array.strides[1]) )));
        ...
        /* "tigramite/tigramite_cython_code.pyx":101
 *                 tau = k*step
 *                 v[k] = array[t - tau, n]
 *                 ave += v[k]             # <<<<<<<<<<<<<<
 *                 mask *= array_mask[t - tau, n]
 ...
 */
  ...
  /* "tigramite/tigramite_cython_code.pyx":120
 *             patt_mask[t-start, n] = mask
 * 
 *     return (patt, patt_mask, weights)             # <<<<<<<<<<<<<<
 */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_tigramite_tigramite_cython_code, __pyx_k_tigramite_tigramite_cython_code, sizeof(__pyx_k_tigramite_tigramite_cython_code), 0, 0, 1, 1},
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "tigramite.tigramite_cython_code")) {
      if (unlikely(PyDict_SetItemString(modules, "tigramite.tigramite_cython_code", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *             int T,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_9tigramite_21tigramite_cython_code_1_get_neighbors_within_eps_cython, NULL, __pyx_n_s_tigramite_tigramite_cython_code); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *     int[:,:] array_mask,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_9tigramite_21tigramite_cython_code_3_get_patterns_cython, NULL, __pyx_n_s_tigramite_tigramite_cython_code); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 77; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
